...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    GPIO_InitStruct.Pin = Left_VAR_Pin|Right_VAR_Pin|ENC_LCD_Pin|Right_Ver_Pin
                          |Right_Hor_Pin|Left_Ver_Pin|Left_Hor_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, Left_VAR_Pin|Right_VAR_Pin|ENC_LCD_Pin|Right_Ver_Pin
                          |Right_Hor_Pin|Left_Ver_Pin|Left_Hor_Pin);
